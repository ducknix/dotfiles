...
\(fn &optional NO-QUERY-P SKİP-DEPENDENCİES-P NO-ERROR-P FORCE-DEPENDENCİES-P)" nil nil)
...
\(fn STR0NG &optional REGEXP-P)" t nil)
...
\(fn &optional BUFFER NO-SELECT-WİNDOW-P)" t nil)
...
\(fn &optional NO-QUERY-P SKİP-DEPENDENCİES-P NO-ERROR-P FORCE-DEPENDENCİES-P)" t nil)
...
\(fn &optional FİLENAMES BUFFER-NAME DİSPLAY-P)" t nil)

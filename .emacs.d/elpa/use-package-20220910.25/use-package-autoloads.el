...
\(fn KEYMAP-SYMBOL PACKAGE OVERRİDE)" nil nil)
...
\(fn NAME KEYWORD ARGS REST STATE &optional BİND-MACRO)" nil nil)
...
\(fn NAME KEYWORD ARGS REST STATE &optional OVERRİDE)" nil nil)

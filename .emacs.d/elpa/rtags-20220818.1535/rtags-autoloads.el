...
\(fn &optional PREFİX BUFFER)" t nil)
...
\(fn &optional DEST-WİNDOW)" t nil)

(autoload 'rtags-select "rtags" "\


\(fn &optional OTHER-WİNDOW REMOVE SHOW)" t nil)

(autoload 'rtags-select-other-window "rtags" "\


\(fn &optional NOT-OTHER-WİNDOW)" t nil)
...
\(fn &optional PREFİX DEFAULT-FİLE)" t nil)
...
\(fn &optional EDİFF BUFFER)" t nil)
...
\(fn &optional DEST-WİNDOW CENTER-WİNDOW TRY-DECLARATİON-FİRST)" t nil)
...
\(fn &optional BUFFER PERİODİC)" t nil)
...
\(fn &optional HİDE-EMPTY POS)" t nil)

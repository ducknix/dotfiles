...
\(fn PROMPT COLLECTİON &key TEST İNİTİAL-İNPUT DEFAULT PRESELECT (BUFFER \"*Helm Completions*\") MUST-MATCH FUZZY REVERSE-HİSTORY (REQUİRES-PATTERN 0) (HİSTORY nil SHİSTORY) RAW-HİSTORY İNPUT-HİSTORY (CASE-FOLD helm-comp-read-case-fold-search) (PERSİSTENT-ACTİON nil) (PERSİSTENT-HELP \"DoNothing\") (MODE-L0NE helm-comp-read-mode-line) HELP-MESSAGE (KEYMAP helm-comp-read-map) (NAME \"Helm Completions\") HEADER-NAME CANDİDATES-İN-BUFFER DİACRİTİCS MATCH-PART MATCH-DYNAMİC EXEC-WHEN-ONLY-ONE QUİT-WHEN-NO-CAND (VOLATİLE t) SORT FC-TRANSFORMER HİST-FC-TRANSFORMER (MARKED-CANDİDATES helm-comp-read-use-marked) NOMARK (ALİSTP t) (CANDİDATE-NUMBER-LİMİT helm-candidate-number-limit) MULTİLİNE ALLOW-NEST COERCE (GROUP \\='helm))" nil nil)
...
\(fn PROMPT &key (NAME \"Read File Name\") İNİTİAL-İNPUT (BUFFER \"*Helm file completions*\") TEST NORET (CASE-FOLD helm-file-name-case-fold-search) PRESELECT HİSTORY MUST-MATCH (FUZZY t) DEFAULT MARKED-CANDİDATES (CANDİDATE-NUMBER-LİMİT helm-ff-candidate-number-limit) NOMARK (ALİSTP t) (PERSİSTENT-ACTİON-İF \\='helm-find-files-persistent-action-if) (PERSİSTENT-HELP \"Hit1 Expand Candidate, Hit2 or (C-u) Find file\") (MODE-L0NE helm-read-file-name-mode-line-string))" nil nil)

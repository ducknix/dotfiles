...
\(fn KEYMAP KEY FUNCTİONS &optional DELAY)" nil nil)
...
\(fn NAME DOCSTRİNG FUNS &optional DELAY)" nil t)
...
\(fn MAP KEY SUBKEY COMMAND &optional OTHER-SUBKEYS PROMPT EXİT-FN DELAY DOCSTRİNG)" nil nil)

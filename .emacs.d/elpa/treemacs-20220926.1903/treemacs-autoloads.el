...
\(fn 0CON &rest FİLE-EXTENSİONS)" nil nil)
...
\(fn FİLE &rest FİLE-EXTENSİONS)" nil nil)
...
\(fn EXTENSİONS MODE-İCON-ALİST)" nil nil)
...
\(fn BTN &optional RECURSİVE)" nil nil)
...
\(fn BTN ARG FİND-WİNDOW)" nil nil)

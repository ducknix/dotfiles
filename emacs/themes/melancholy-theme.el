...
;;   (font-family-condensed "Ubuntu" )
     (font-family-cursive   "Ubuntu Mono") ;; i don't like Milkshake :/
     (my-active             "#F92672" )
     (my-visited            "#999999" )
     (my-info               "#FFB728" )
     (my-highlight          "#96BF33" )
     (my-contrast           "#666666" ) ;; #666666
     (my-deepcontrast       "#444444" ) ;; #444444
...
;;;; Theme Faces
  (custom-theme-set-faces
    ...
    `(line-number ((t (:foreground ,line-color ))))
    ...
    `(font-lock-keyword-face ((t (:family ,font-family-cursive :height 1.2 :foreground ,my-active ))))
